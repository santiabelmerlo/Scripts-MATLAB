    ...
    for d = 1:length(D_folders)
        ...
        if exist(file_path, 'file') && exist(sessioninfo_path, 'file') == 2
            ...
            if ~isempty(ch)
                ...
                params.fpass = [0 130];
                movingwin = [1 0.1];
                disp(['    Analizing BLA low frequency single-taper spectrogram...']);
                ...
                params.fpass = [30 130];
                movingwin = [0.1 0.01];
                disp(['    Analizing BLA high frequency single-taper spectrogram...']);
                [S,t,f,Serr] = mtspecgramc(amplifier_lfp, movingwin, params);
                % Save the results to a .mat file
                % Guardamos solo las variables f,S,Serr,t
            ...
            if ~isempty(ch)
                ...
                params.fpass = [0 130];
                movingwin = [1 0.1];
                disp(['    Analizing PL low frequency single-taper spectrogram...']);
                [S,t,f,Serr] = mtspecgramc(amplifier_lfp, movingwin, params);
                % Save the results to a .mat file
                % Guardamos solo las variables f,S,Serr,t
                ...
                params.fpass = [30 130];
                movingwin = [0.1 0.01];
                disp(['    Analizing PL high frequency single-taper spectrogram...']);
                [S,t,f,Serr] = mtspecgramc(amplifier_lfp, movingwin, params);
                % Save the results to a .mat file
                % Guardamos solo las variables f,S,Serr,t
            ...
            if ~isempty(ch)
                ...
                params.fpass = [0 130];
                movingwin = [1 0.1];
                disp(['    Analizing IL low frequency single-taper spectrogram...']);
                [S,t,f,Serr] = mtspecgramc(amplifier_lfp, movingwin, params);
                % Save the results to a .mat file
                % Guardamos solo las variables f,S,Serr,t
                ...
                params.fpass = [30 130];
                movingwin = [0.1 0.01];
                disp(['    Analizing IL high frequency single-taper spectrogram...']);
                [S,t,f,Serr] = mtspecgramc(amplifier_lfp, movingwin, params);
                % Save the results to a .mat file
                % Guardamos solo las variables f,S,Serr,t
