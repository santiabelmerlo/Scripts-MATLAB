%% CCG (Cross-Correlograms) para eventos de freezing y movilidad
...
frange = 2; % Filtro por el rango de frecuencias que quiero analizar. Valor de 1 a 5 (4Hz,theta,beta,sgamma,fgamma)
    ...
    for d = 1:length(D_folders)
        ...
        if exist(strcat(name,'_sessioninfo.mat')) == 2;
            ...
            if exist(strcat(name, '_lfp.dat')) && ...
                ...
                % Nos quedamos solo con los eventos de movilidad que duran más de 3 seg
                inicio_movement = inicio_movement(duracion_movement >= 3);
                fin_movement = fin_movement(duracion_movement >= 3);
                duracion_movement = duracion_movement(duracion_movement >= 3);
                ...
                pos2 = fin_movement > t(end) - 10; % Aquellos eventos de movement que terminen dentro de los últimos 10 seg de señal
                ...
                if exist('lfp_BLA') && exist('lfp_PL') && exist('lfp_IL')
                    ...
                    for i = 1:length(inicio_movement)
                        % Movement
                        indices_nofz = (tt >= inicio_movement(i)) & (tt <= fin_movement(i));
                ...
                clear lfp_BLA lfp_PL lfp_IL X1 X2 filt_BLA filt_PL filt_IL inicio_freezing fin_freezing...
                    inicio_movement fin_movement duracion_movement duracion_freezing
