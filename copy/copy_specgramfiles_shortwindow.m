...
for r = 1:length(R_folders)
    ...
    for d = 1:length(D_folders)
        ...
        spec1 = strcat(name, '_specgram_BLA_ShortWindow.mat');
        spec2 = strcat(name, '_specgram_PL_ShortWindow.mat');
        spec3 = strcat(name, '_specgram_IL_ShortWindow.mat');
        ...
        % Copiamos R00D00_specgram_BLA_ShortWindow.mat
        ...
        % Copiamos R00D00_specgram_PL_ShortWindow.mat
        ...
        % Copiamos R00D00_specgram_IL_ShortWindow.mat
