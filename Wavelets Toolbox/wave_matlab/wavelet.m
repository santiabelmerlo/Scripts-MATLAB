...
%   
%   Comentarios de Santiago Merlo al 26-11-24
%   Para calcular la wavelet en un rango de frecuencias determinado usar
%   los siguientes parámetros
%   Fs = 1250;  % Frecuencia de muestreo en Hz
%   Pad = 1; 	% Nivel de padding que uno quiere aplicar
%   LowFreq = 1;  % Frecuencia mínima en Hz
%   HighFreq = 16;  % Frecuencia máxima en Hz
%   NumBands = 32;  % Número de bandas para la transformada wavelet
%   dj = log2(((1/LowFreq)/(1/HighFreq)))/NumBands;
%   [wavelet,period,scale,coi] = wavelet(lfp,1/Fs,Pad,dj,1/HighFreq,NumBands);
%   wave = log(abs(wavelet).^2);
%   f = 1./period;
%
