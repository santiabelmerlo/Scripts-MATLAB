function plot_GCf(data,lam,lim_x)
    ...
    x = lam;
    % Plot 1
    y = (smooth(mean(squeeze(data(2,1,:,:)),2),1))';
    stdem = (smooth(std(squeeze(data(2,1,:,:)),1,2)/sqrt(size(squeeze(data(2,1,:,:)),2)),1))';
    curve1 = y + stdem;
    curve2 = y - stdem;
    x2 = [x, fliplr(x)];
    ...
    % Plot 2
    y = (smooth(mean(squeeze(data(1,2,:,:)),2),1))';
    stdem = (smooth(std(squeeze(data(1,2,:,:)),1,2)/sqrt(size(squeeze(data(1,2,:,:)),2)),1))';
    curve1 = y + stdem;
    curve2 = y - stdem;
    x2 = [x, fliplr(x)];
    inBetween = [curve1, fliplr(curve2)];
    ...
    x = lam;
    % Plot 1
    y = (smooth(mean(squeeze(data(3,1,:,:)),2),1))';
    stdem = (smooth(std(squeeze(data(3,1,:,:)),1,2)/sqrt(size(squeeze(data(3,1,:,:)),2)),1))';
    curve1 = y + stdem;
    curve2 = y - stdem;
    x2 = [x, fliplr(x)];
    inBetween = [curve1, fliplr(curve2)];
    ...
    p2 = plot(x, y, 'Color',BLA_color, 'LineWidth', 1); hold on;
    % Plot 2
    y = (smooth(mean(squeeze(data(1,3,:,:)),2),1))';
    stdem = (smooth(std(squeeze(data(1,3,:,:)),1,2)/sqrt(size(squeeze(data(1,3,:,:)),2)),1))';
    curve1 = y + stdem;
    curve2 = y - stdem;
    x2 = [x, fliplr(x)];
    inBetween = [curve1, fliplr(curve2)];
    ...
    x = lam;
    % Plot 1
    y = (smooth(mean(squeeze(data(3,2,:,:)),2),1))';
    stdem = (smooth(std(squeeze(data(3,2,:,:)),1,2)/sqrt(size(squeeze(data(3,2,:,:)),2)),1))';
    curve1 = y + stdem;
    curve2 = y - stdem;
    x2 = [x, fliplr(x)];
    inBetween = [curve1, fliplr(curve2)];
    ...
    % Plot 2
    y = (smooth(mean(squeeze(data(2,3,:,:)),2),1))';
    stdem = (smooth(std(squeeze(data(2,3,:,:)),1,2)/sqrt(size(squeeze(data(2,3,:,:)),2)),1))';
    curve1 = y + stdem;
    curve2 = y - stdem;
    x2 = [x, fliplr(x)];
    inBetween = [curve1, fliplr(curve2)];
