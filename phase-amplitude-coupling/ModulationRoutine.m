...
t = t1(1,100000:200000);
lfp = lfp1(1,100000:200000);
...
% Plot comodulogram
figure();
contourf(PhaseFreqVector+PhaseFreq_BandWidth/2,AmpFreqVector+AmpFreq_BandWidth/2,Comodulogram',30,'lines','none'); % Aumentar valor de 30 a 1000 Si quiero más 
set(gca,'fontsize',14);
...
PhaseFreq_Band = [9, 10]; % Phase frequency band
