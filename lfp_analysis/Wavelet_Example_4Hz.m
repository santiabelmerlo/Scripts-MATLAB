...
lfp = lfp_BLA(1,pos-(Fs*30):pos+(Fs*180));
t = amplifier_t(1,pos-(Fs*30):pos+(Fs*180));
t1 = t;
...
%     f = interp(f,smooth);
    ...
    pos_cb1 = get(cb1, 'Position');
    set(cb1, 'Position', [pos_cb1(1) pos_cb1(2)+0.12 pos_cb1(3)-0.02 pos_cb1(4)-0.25]);
    pos_ax1 = get(ax1, 'Position');
    set(ax1, 'Position', [pos_ax1(1) pos_ax1(2) pos_ax1(3)-0.005 pos_ax1(4)]);
